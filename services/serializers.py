...
def account_to_dict(account: AccountCatalog) -> dict[str, Any]:
    return {
        ...
        "is_recurring_expense": bool(getattr(account, "is_recurring_expense", 0)),
        "legacy_payload_key": getattr(account, "legacy_payload_key", None),
        "is_postable": bool(getattr(account, "is_postable", 0)),
